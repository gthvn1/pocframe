...
let () =
  ...
  run "Frameforge"
    [
      ( "get-interface",
        [
          test_case "Mac exist" `Quick test_find_mac;
          test_case "Dev unkown" `Quick test_unknown_dev;
        ] );
    ]
